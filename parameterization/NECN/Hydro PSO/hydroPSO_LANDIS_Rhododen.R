...
# obs <- obs[1:2,]
obs_bio <- c(1223, 1190)  # based on greatest biomass and lai calculated from FIA data
obs_lai <- c(1.63, 1.63) 
...
MaxBiomass_bs <- subset(max_observed, max_observed$species=="Rhododen")
...
ggsave("Rhododen_biomass_1startcohort_35particles.png",
       plot = last_plot(),
       path = "PSO.out/",
       dpi = 300,
       limitsize = TRUE)
...
ggsave("Rhododen_LAI_1startcohort_35particles.png",
       plot = last_plot(),
       path = "PSO.out/",
       dpi = 300,
       limitsize = TRUE)
